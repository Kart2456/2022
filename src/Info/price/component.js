...
export default function PlitkaPrice(props) {
    ...
    const  PopupExample = (props) => (
        ...
        <Popup ref={ref} contentStyle ={contentStyle} trigger={<button style={props.style}>Больше фото</button>} position="middle center" arrow = {false}>
          <div>
              <div style={styles.popup}>
                ...
                <div style={styles.cont}>
                    <img style={styles.miniimg} src= {props.miniimg} />
                    <img style={styles.miniimg} src= {props.miniimg} />
                    <img style={styles.miniimg} src= {props.miniimg} />
                    <img style={styles.miniimg} src= {props.miniimg} />
                </div>
    ...
    return (
        <div>
            ...
            <div style={stylessr.fon}>
                ...
                <PopupExample miniimg = {props.miniimg} style={stylessr.cnopka} arrow = {false} modal/>
            </div>
            <div style={stylessr.fon}>
                <img style={stylessr.img} src= {props.img} />
                <div style={stylessr.block}>
                ...
                <PopupExample miniimg = {props.miniimg} style={stylessr.cnopka} arrow = {false} modal position = "top center"/>
            ...
            <div style={stylesmin.fon}>
                ...
                <div style={stylesmin.block}>
                    ...
                    <p style={stylesmin.price}>Аренда площадки: от <span style={stylesmin.cena}>{props.price}</span> руб/м2 в месяц (в т.ч. НДС 20%)</p>
                    <p style={stylesmin.info}>{props.info}</p>
                </div>
                <PopupExample miniimg = {props.miniimg} style={stylesmin.cnopka} arrow = {false} modal/>
            </div>
            </MediaQuery>
        </div>
    );
